...
import geoData from "../../data/topo/germany-county-topo.json";
import metaData from "../../data/meta/germany-county-meta.json";
import labelData from "../../data/labels/germany-state-labels.json";

export const GermanyMap: React.FC<MapProps> = ({
  chart,
  chartData,
  startDate,
  endDate,
  ...
  const geoScale = height * 3 * scalingFactor;
